...
<center><h3 style="font-weight: bold;">STUDENTS GRIEVANCE SYSTEM</h3></center>
	...
	<div class="complaint-body col-md-6" style="margin: 0 auto;text-align: center;">
		<form action="index.php" method="POST" role="form" class="form-horizontal">
			<div class="form-group">
				...
				<textarea name="complaint" class="form-control" placeholder="Type Complaint Here and the Faculty name..." style="height: 200px;background: #F0FFF0;"></textarea>
			</div>
			<div class="form-group">
